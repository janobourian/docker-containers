...
1. [Martin Fowler: Microservices Application Testing with Docker Compose](https://martinfowler.com/)
2. [Brendan Gregg: Multi-Container Networking and Epoll Performance](https://www.brendangregg.com/)
3. [Liz Rice: Understanding Docker Network Bridges and Container DNS](https://www.lizrice.com/)
4. [Julia Evans: How Docker Networking and DNS Works Under the Hood](https://jvns.ca/)
5. [High-Performance Linux Systems: Tuning Redis and Postgres Stacks in Compose](https://www.kernel.org/)
