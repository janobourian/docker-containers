...
1. [Brendan Gregg: Linux Process Lifecycle, Signals, and Container Metrics](https://www.brendangregg.com/)
2. [Julia Evans: How Does Docker Stop a Container? Signals and Timeouts](https://jvns.ca/)
3. [Martin Fowler: Designing Containerized Applications for Graceful Shutdown](https://martinfowler.com/)
4. [Liz Rice: Understanding Container Process Trees and Init Systems](https://www.lizrice.com/)
5. [High-Performance Linux Systems: Tuning Container Healthchecks and Signal Traps](https://www.kernel.org/)
