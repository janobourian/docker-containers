...
6. [Julia Evans: What Happens When You Run a Container? Namespaces and Cgroups](https://jvns.ca/)
7. [Brendan Gregg: Linux Cgroups Performance & Throttling Metrics](https://www.brendangregg.com/)
8. [Liz Rice: Container Security: Fundamental Technology of Containers](https://www.oreilly.com/library/view/container-security/9781492056690/)
9. [Martin Fowler: Microservices and Container Process Isolation](https://martinfowler.com/)
10. [High-Performance Linux Systems: OverlayFS Internals & Inode Management](https://www.kernel.org/doc/html/latest/filesystems/overlayfs.html)
