...
6. [Julia Evans: How Docker Networking and DNS Works](https://jvns.ca/)
7. [Brendan Gregg: Linux Network Performance, iptables and NAT Profiling](https://www.brendangregg.com/)
8. [Liz Rice: Understanding Container Networking from Scratch](https://www.lizrice.com/)
9. [Martin Fowler: Microservices Zero-Trust Network Segmentation](https://martinfowler.com/)
10. [High-Performance Linux Systems: Tuning iptables and VXLAN MTU for Containers](https://www.kernel.org/)
