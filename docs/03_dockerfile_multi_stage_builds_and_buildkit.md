...
1. [Liz Rice: Anatomy of a Container Image and OCI Manifests](https://www.lizrice.com/)
2. [Julia Evans: How Docker Builds Layers and Cache Invalidation](https://jvns.ca/)
3. [Martin Fowler: Patterns for Container Image Delivery and Immutability](https://martinfowler.com/)
4. [Brendan Gregg: Performance Profiling of Container Build Systems](https://www.brendangregg.com/)
5. [High-Performance Linux Systems: Multi-Arch Emulation with QEMU and Binfmt](https://www.kernel.org/)
