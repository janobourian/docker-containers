...
1. [Brendan Gregg: Linux Container Performance and Cgroup Overhead](https://www.brendangregg.com/)
2. [Julia Evans: What Are Containers Made Of? Namespaces, Cgroups, and OverlayFS](https://jvns.ca/blog/2016/10/10/what-even-is-a-container/)
3. [Liz Rice: Building a Container from Scratch in Go](https://www.lizrice.com/)
4. [Martin Fowler: Microservices and Container Deployment Patterns](https://martinfowler.com/articles/microservices.html)
5. [High-Performance Linux Systems: Tuning Container Cgroups and Namespaces](https://www.kernel.org/doc/Documentation/)
