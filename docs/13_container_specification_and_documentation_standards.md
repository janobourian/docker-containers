...
1. [Martin Fowler: Microservice Prerequisites and Container Architecture](https://martinfowler.com/)
2. [Brendan Gregg: Linux Performance and Container Resource Profiling](https://www.brendangregg.com/)
3. [Liz Rice: Container Security and Linux System Internals (O'Reilly)](https://www.lizrice.com/)
4. [Julia Evans: Bite-Sized Linux Namespaces, Cgroups, and Networking Guides](https://jvns.ca/)
5. [FinOps Foundation: Framework for Cloud Container Financial Governance](https://www.finops.org/)
